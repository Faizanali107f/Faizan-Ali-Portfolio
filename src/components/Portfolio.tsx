...
const projects = [
  ...
  {
    title: 'RT Centre',
    categories: ['WordPress', 'Education', 'Custom Development'],
  ...
  {
    title: 'CloudFortix',
    categories: ['WordPress', 'Business', 'Custom Development'],
