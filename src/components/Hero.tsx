        ...
        <div className="grid lg:grid-cols-12 gap-10 md:gap-12 items-center">
          ...
          >
            ...
            <motion.h1
              ...
              className="text-[2.25rem] xs:text-5xl sm:text-6xl md:text-7xl lg:text-[5.5rem] font-bold tracking-[-0.03em] leading-[1.05] sm:leading-[0.95] mb-6 md:mb-8 break-words"
            >
